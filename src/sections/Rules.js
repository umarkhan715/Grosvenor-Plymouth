                    ...
                    <div className="row">
                        <div className="col-sm-12 col-sm-offset-2">
                            ...
                            <div className="terms-body">
                                ...
                                <hr />
                                <h2>Correction of Errors and Inaccuracies</h2>
                                ...
                                <p>
                                    ...
                                    <div className="container terms_footer"> <h2>Can't find what you're looking for? <a href="www.themainalabel.com">Email us</a></h2>
                                    </div>
